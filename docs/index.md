# NotiLog — эффективное управление событиями и уведомлениями

<div style="display: flex; align-items: center;">
  <img src="images/logo-nobg.svg" alt="NotiLog Logo" style="width: 150px; margin-right: 20px;">
  <div>
    <p><strong>NotiLog</strong> — это решение для управления событиями, отправки мгновенных уведомлений и эскалации инцидентов, которая поможет вам эффективно отслеживать и управлять важными событиями в вашем приложении.</p>
  </div>
</div>
