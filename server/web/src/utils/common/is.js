...
/** Пустой массив | Пустая строка | Пустой объект | Пустой Map | Пустой Set */
...
/**
 * * Аналог функции IFNULL из mysql
 * * Если первый параметр null/undefined/'' возвращает второй параметр как запасное значение, иначе возвращает первый параметр
